...
class Hyperparams:
    '''Hyperparameters'''
    # data
    raw_data = 'corpus/camp-raw.txt'
    train_data = 'corpus/camp-train.txt'
    test_data = 'corpus/camp-test.txt'
    valid_data = 'corpus/camp-valid.txt'


    source_train = 'corpus/camp-src.txt'
